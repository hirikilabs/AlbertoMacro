...
#define MAX_DISTANCE  20     // mm
#define MIN_DISTANCE  1      // mm
...
#define STEPS_MM      STEPS_REV                   // Leadscrew 1mm
...
// variables
uint16_t distance_mm = 20;
uint16_t time_s = 300;
uint16_t num_pics = 100;
uint16_t exp_time_s = 1;
...
int read_LCD_buttons()
{
  ...
  if (adc_key_in < 300)  return BTN_DOWN;
  if (adc_key_in < 500)  return BTN_LEFT;
  if (adc_key_in < 700)  return BTN_SELECT;
